      ...
      nutri.map((item) => {
        return (
            ...
            >
              ...
              <a href="/" className="flex justify-center h-8 border border-2 border-blue-500 rounded-md text-lg font-bold text-blue-500 hover:bg-blue-500 hover:text-white">Acessar</a>
